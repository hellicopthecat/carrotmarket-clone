...
export default function Home() {
  ...
  const onEmailClick = () => setMethod("Email Address");
  const onPhoneClick = () => setMethod("Phone Number");
  return (
    <NavComp title="홈">
      <div title="HOME" className="mt-8 px-4">
        ...
        <div className="mt-16">
          ...
          <form className="flex flex-col mt-8" action="">
            ...
            <div className="mt-2">
              ...
              {method === "Phone Number" ? (
                <div className="flex">
                  <span className="flex items-center justify-center px-3 rounded-l-md border-r-0 border">
                    +82
                  </span>
                  <input
                    id="input"
            ...
            <button className="bg-orange-500 hover:bg-orange-600 text-white py-3 px-4 border-transparent rounded-md shadow-sm font-medium focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 focus:outline-none mt-6">
              {method === "Email Address" ? "Get login link" : null}
              {method === "Phone Number" ? "Get one-time password" : null}
            </button>
          </form>
          <div className="mt-6">
