...
export default function UserProfile() {
  return (
    <div className="py-10 px-4">
      <Profile
        cls=""
        profileImgSize="w-16 h-16 bg-slate-700"
        userName="Steve Jebs"
        userFont="text-gray-900 font-medium"
        msg="Edit profile &rarr;"
        msgFont="text-gray-700"
      />

      <div className="mt-10 flex justify-around">
        <Link href="/userprofile/sold">
        ...
        <Link href="/userprofile/interest">
          <div className="flex flex-col items-center">
            <div className="w-14 h-14 text-white bg-orange-500 rounded-full flex items-center justify-center">
              <svg
                className="w-6 h-6"
