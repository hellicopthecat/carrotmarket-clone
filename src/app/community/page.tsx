      ...
      {[1, 2, 3, 4, 5, 6].map((_, i) => (
        <Link key={i} href={`/community/${i}`}>
          <div className=" cursor-pointer flex flex-col items-start">
            <span className="flex items-center px-2.5 py0,5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">
              동네질문
            </span>
            ...
            <div className="mt-5 flex items-center justify-between w-fill text-gray-500 font-medium text-xs">
              <span>니꼬</span>
              <span>18시간 전</span>
            </div>
            <div className="flex space-x-5 mt-3 text-gray-700 py-2.5 border-t border-b-[1px] w-full">
