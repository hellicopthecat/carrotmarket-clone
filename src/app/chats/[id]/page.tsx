        ...
        <div className="fixed w-full mx-auto max-w-md bottom-0 inset-x-0">
          <div className="flex items-center relative">
            ...
            <div className="absolute inset-y-0 flex py-1.5 pr-1.5 right-0">
              <button className="flex items-center focus:ring-2 focus:ring-offset-2 focus:ring-orange-700 bg-orange-500 rounded-full px-3 text-sm text-white">
                &rarr;
              </button>
            </div>
          </div>
